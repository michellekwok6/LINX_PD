...
class NuclearRates(eqx.Module): 
    ...
    def __init__(
        ...
        max_i_species=None, pd_model = None
    ):
        """
        Populates the class. 
    ...
    def populate(self, network, pd_model): 
        ...
        if self.pd_model != None:  
            ...
            other_rxns_dict['dgpn'] = Reaction(
                'dgpn', (2, ), (0, 1), 0, 1, 0, 
                frwrd_rate_param_func=PD_FUNCS.dgnp_frwrd_rate)
            
            other_rxns_dict['tgnd'] = Reaction(
                'tgnd', (3, ), (0, 2), 0, 1, 0, 
                frwrd_rate_param_func=PD_FUNCS.tgnd_frwrd_rate)
            
            other_rxns_dict['tgnpn'] = Reaction(
                'tgnpn', (3, ), (0, 0, 1), 0, 1, 0, 
                frwrd_rate_param_func=PD_FUNCS.tgnpn_frwrd_rate)
            
            other_rxns_dict['He3gpd'] = Reaction(
                'He3gpd', (4, ), (1, 2), 0, 1, 0, 
                frwrd_rate_param_func=PD_FUNCS.He3gpd_frwrd_rate)
            
            other_rxns_dict['He3gnpp'] = Reaction(
                'He3gnpp', (4, ), (0, 1, 1), 0, 1, 0, 
                frwrd_rate_param_func=PD_FUNCS.He3gnpp_frwrd_rate)
            
            other_rxns_dict['He4gpt'] = Reaction(
                'He4gpt', (5, ), (1, 3), 0, 1, 0, 
                frwrd_rate_param_func=PD_FUNCS.He4gpt_frwrd_rate)
            
            other_rxns_dict['He4gnHe3'] = Reaction(
                'He4gnHe3', (5, ), (0, 4), 0, 1, 0, 
                frwrd_rate_param_func=PD_FUNCS.He4gnHe3_frwrd_rate)            

            other_rxns_dict['He4gdd'] = Reaction(
                'He4gdd', (5, ), (2, 2), 0, 1, 0, 
                frwrd_rate_param_func=PD_FUNCS.He4gdd_frwrd_rate)

            other_rxns_dict['He4gnpd'] = Reaction(
                'He4gnpd', (5, ), (0, 1, 2), 0, 1, 0, 
                frwrd_rate_param_func=PD_FUNCS.He4gnpd_frwrd_rate)
            
            other_rxns_dict['Li6gnpHe4'] = Reaction(
                'Li6gnpHe4', (9, ), (0, 1, 5), 0, 1, 0, 
                frwrd_rate_param_func=PD_FUNCS.Li6gnpHe4_frwrd_rate)   
            
            '''
            other_rxns_dict['Li6gX'] = Reaction(
                'Li6gnpHe4', (9, ), ( , ), 0, 1, 0, 
                frwrd_rate_param_func=PD_FUNCS.Li6gX_frwrd_rate) 
            '''

            other_rxns_dict['Li7gtHe4'] = Reaction(
                'Li7gtHe4', (6, ), (3, 5), 0, 1, 0, 
                frwrd_rate_param_func=PD_FUNCS.Li7gtHe4_frwrd_rate)
            
            other_rxns_dict['Li7gnLi6'] = Reaction(
                'Li7gnLi6', (6, ), (0, 9), 0, 1, 0, 
                frwrd_rate_param_func=PD_FUNCS.Li7gnLi6_frwrd_rate) 

            other_rxns_dict['Li7gnnpHe4'] = Reaction(
                'Li7gnnpHe4', (6, ), (0, 0, 1, 5), 0, 1, 0, 
                frwrd_rate_param_func=PD_FUNCS.Li7gnnpHe4_frwrd_rate) 
            
            other_rxns_dict['Be7gHe3He4'] = Reaction(
                'Be7gHe3He4', (7, ), (4, 5), 0, 1, 0, 
                frwrd_rate_param_func=PD_FUNCS.Be7gHe3He4_frwrd_rate) 
            
            other_rxns_dict['Be7gpLi6'] = Reaction(
                'Be7gpLi6', (7, ), (1, 9), 0, 1, 0, 
                frwrd_rate_param_func=PD_FUNCS.Be7gpLi6_frwrd_rate) 
            
            other_rxns_dict['Be7gppnHe4'] = Reaction(
                'Be7gppnHe4', (7, ), (0, 1, 1, 5), 0, 1, 0, 
                frwrd_rate_param_func=PD_FUNCS.Be7gppnHe4_frwrd_rate) 
